...
1. ~~CI sobre o commit final e verificação da interface em navegador.~~ Concluído nesta candidata: `quality` (run 179) e `CodeQL` (run 47) verdes no commit remoto `206ca327abb62ca894bbfb2c09bc88010d43c039`; previews Web/API `READY` e smoke check público do Web concluído.
